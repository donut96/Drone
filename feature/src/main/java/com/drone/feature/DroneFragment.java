 ...
 * {@link DroneFragment.OnFragmentInteractionListener} interface
...
public class DroneFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewPager viewPager = RootView.findViewById(R.id.vp_drone);
        if (viewPager != null) {
            viewPager.setAdapter(new SimplePagerAdapter(getContext()));
        }


//        viewPager.setPageTransformer(false, new ParallaxPagerTransformer(R.id.vp_drone));
